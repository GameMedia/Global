function view(id){
	...
	jQuery.ajax({
			url:  domain+"management-content/content_types/getContent_TypesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_content_types'),
			success: function(data) {
										...
										loadingHide('#form_content_types');
									}
		   });	
}
