						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="3" data-column="3" selected>Default Menu</option>
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="heading">
									...
									<th>User Type</th>
									<th>Name</th>
									<th class="no-sort" width="130px">Default Menu</th>
								...
								<tr role="row" class="filter">
									...
									<td>
										<select name="search_default_menu" id="search_default_menu" class="form-control form-filter input-sm">
											<option value="">- All -</option>
											<?php 
