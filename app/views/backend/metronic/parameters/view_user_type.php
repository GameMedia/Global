						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">								
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="2" data-column="2" selected>Is Admin?</option>
				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_user_type" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please choose is Admin" data-container="body"></i>
											<input type="checkbox" id="isAdmin" name="isAdmin" class="make-switch switch-isAdmin" data-on-text="<i class='fa fa-check'></i>" data-off-text="<i class='fa fa-times'></i>">
										</div>
									  </div>
									</div>
	...
	<script type="text/javascript" src="<?php echo ASSETS_JS;?>backend/parameters/user_type.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_user_type', rules);
            
			TableAjax.init("datatable", "parameters/usertype/loadUser_Type");
			UIToastr.init();
